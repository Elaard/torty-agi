    ...
    return (
      <div className="border rounded-lg p-4 mb-4">
        <div className="flex justify-between items-center mb-3">
          <h4 className="font-medium">Kreacja {slotNumber}</h4>
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Wybierz maksymalnie 3 produkty, które będą wyświetlane w sekcji "Nasze Kreacje" na stronie głównej. Możesz wybrać produkt z rozwijanej listy
          dla każdego slotu lub zmienić już wybrany produkt.
        </p>
      </div>
