...
const ImageUploader = forwardRef<ImageUploaderHandle, ImageUploaderProps>(({ onImageUploaded, currentImageUrl, onFileSelected }, ref) => {
  ...
  // Public method to upload the selected file
      ...
      >
        {previewUrl ? (
          <div className="relative">
            ...
            />
            <div className="mt-2 text-sm text-gray-500">Kliknij, aby zmienić obraz</div>
          </div>
        ) : (
          <div className="py-4">
